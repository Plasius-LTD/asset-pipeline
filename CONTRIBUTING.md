# Contributing to @plasius/asset-pipeline
...
`@plasius/asset-pipeline` provides orchestration primitives for the unified AI asset lifecycle:

- Asset job state transitions and validation,
- Manifest assembly and promotion planning,
- Adapter ports for intake, processing, and review flows,
- Typed helpers that keep asset pipeline rules reusable across services.

Contributions typically fall into: pipeline state modeling, orchestration helpers, adapter contracts, docs, and tooling quality.
